...
public class Generate extends AbstractAcceleoGenerator {
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(br.com.meimodel.MeimodelPackage.class)) {
            resourceSet.getPackageRegistry().put(br.com.meimodel.MeimodelPackage.eINSTANCE.getNsURI(), br.com.meimodel.MeimodelPackage.eINSTANCE);
        }
